...
import { FileText, Save, Download, Upload, Play, RefreshCw, Settings, Plus, Eye, Code, Split, File, Menu } from 'lucide-react';
      ...
      <div className="flex flex-row h-full w-full">
        ...
        <div
          className={`bg-gray-800 text-white flex flex-col shadow-xl transition-transform duration-300 ${
            isSidebarVisible ? 'w-64 translate-x-0' : 'w-0 -translate-x-full overflow-hidden'
